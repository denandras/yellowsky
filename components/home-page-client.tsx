          ...
          <section className="relative w-full">
            ...
            >
              <div className={`flex flex-col items-start px-6 transition-all duration-700 ${showTitle ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                <h1 className="font-display font-bold leading-none tracking-tighter text-text-dark translate-y-[clamp(3px,1.5px+0.2vw,5px)]" style={{ fontSize: 'clamp(4.5rem, 4.5rem + 0.5vw, 5.75rem)' }}>
                  {labels.title}
                </h1>
