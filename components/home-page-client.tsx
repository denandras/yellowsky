        ...
        <footer className="bg-background-light py-12 pb-32 text-center">
          ...
          <div className="mb-8 grid grid-cols-2 justify-items-center gap-x-4 gap-y-2 px-4 text-xs text-text-muted max-w-sm mx-auto">
            <span className="flex items-center gap-1.5 text-center">
              ...
              <span>{language === "hu" ? "Ingyenes szállítás" : "Free worldwide shipping"}</span>
            </span>
            <span className="flex items-center gap-1.5 text-center">
              <svg className="size-4 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <span className="flex items-center gap-1.5 text-center">
              ...
              <span>{language === "hu" ? "7-14 munkanapon belül" : "Ships in 7-14 days"}</span>
            </span>
            <span className="flex items-center gap-1.5 text-center">
              <svg className="size-4 text-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
              </svg>
              <span>{language === "hu" ? "Giclée nyomat kenderpapíron" : "Giclée on hemp paper"}</span>
            </span>
          </div>
